...
void BOARD_InitPins(void) {
  ...
  IOMUXC_SetPinMux(
	  IOMUXC_GPIO_AD_24_FLEXIO2_D24,          /* GPIO_AD_10 is configured as FLEXIO2_D10 */
      0U);                                    /* Software Input On Field: Input Path is determined by functionality */
  IOMUXC_SetPinMux(
	  IOMUXC_GPIO_AD_25_FLEXIO2_D25,          /* GPIO_AD_10 is configured as FLEXIO2_D10 */
      0U);                                    /* Software Input On Field: Input Path is determined by functionality */
  IOMUXC_SetPinMux(
	  IOMUXC_GPIO_AD_26_FLEXIO2_D26,          /* GPIO_AD_10 is configured as FLEXIO2_D10 */
      0U);                                    /* Software Input On Field: Input Path is determined by functionality */
  IOMUXC_SetPinMux(
	  IOMUXC_GPIO_AD_27_FLEXIO2_D27,          /* GPIO_AD_10 is configured as FLEXIO2_D10 */
      0U);                                    /* Software Input On Field: Input Path is determined by functionality */
  ...
  IOMUXC_SetPinConfig(
	  IOMUXC_GPIO_AD_24_FLEXIO2_D24,          /* GPIO_AD_10 PAD functional properties : */
  ...
  IOMUXC_SetPinConfig(
	  IOMUXC_GPIO_AD_25_FLEXIO2_D25,          /* GPIO_AD_10 PAD functional properties : */
	  0x03U);                                 /* Slew Rate Field: Slow Slew Rate
                                             	 Drive Strength Field: high drive strength
                                             	 Pull / Keep Select Field: Pull Disable, Highz
                                             	 Pull Up / Down Config. Field: Weak pull down
                                             	 ...
                                             	 Domain write protection lock: Neither of DWP bits is locked */
  IOMUXC_SetPinConfig(
	  IOMUXC_GPIO_AD_26_FLEXIO2_D26,          /* GPIO_AD_10 PAD functional properties : */
	  0x03U);                                 /* Slew Rate Field: Slow Slew Rate
                                             	 Drive Strength Field: high drive strength
                                             	 Pull / Keep Select Field: Pull Disable, Highz
                                             	 Pull Up / Down Config. Field: Weak pull down
                                             	 ...
                                             	 Domain write protection lock: Neither of DWP bits is locked */
  IOMUXC_SetPinConfig(
	  IOMUXC_GPIO_AD_27_FLEXIO2_D27,          /* GPIO_AD_10 PAD functional properties : */
	  0x03U);                                 /* Slew Rate Field: Slow Slew Rate
                                             	 Drive Strength Field: high drive strength
                                             	 Pull / Keep Select Field: Pull Disable, Highz
                                             	 Pull Up / Down Config. Field: Weak pull down
